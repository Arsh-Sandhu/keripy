...
echo "create/open alice wallet; issue icp event"
## Esf8b_AngI1d0KbOFjPGIfpVani0HTagWeaYTLs14PlE
## Passcode: DoB2-6Fj4x-9Lbo-AFWJr-a17O
# Es1jlzU-XGhjG8rMrSb1mmoi_KuUNbRouhr8aE3In4dY
curl -s -X POST "http://localhost:5630/boot" -H "accept: */*" -H "Content-Type: application/json" -d "{\"name\":\"alice\",\"passcode\":\"DoB2-6Fj4x-9Lbo-AFWJr-a17O\",\"salt\":\"0AMDEyMzQ1Njc4OWxtbm9dEf\"}" | jq
sleep 1
curl -s -X PUT "http://localhost:5630/boot" -H "accept: */*" -H "Content-Type: application/json" -d "{\"name\":\"alice\",\"passcode\":\"DoB2-6Fj4x-9Lbo-AFWJr-a17O\"}" | jq
sleep 5
curl -s -X POST "http://localhost:5630/ids/alice" -H "accept: */*" -H "Content-Type: application/json" -d "{\"transferable\":true,\"wits\":[\"BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\", \"BuyRFMideczFZoapylLIyCjSdhtqVb31wZkRKvPfNqkw\",\"Bgoq68HCmYNUDgOz4Skvlu306o_NY-NrYuKAVhk3Zh9c\"],\"toad\":3, \"icount\":1,\"ncount\":1,\"isith\":1,\"nsith\":1}" | jq
...
echo 'resolving alice'
curl -s -X POST "http://localhost:5623/oobi" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"alice\", \"url\":\"http://127.0.0.1:5642/oobi/Es1jlzU-XGhjG8rMrSb1mmoi_KuUNbRouhr8aE3In4dY/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\"}" | jq
curl -s -X POST "http://localhost:5626/oobi" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"alice\", \"url\":\"http://127.0.0.1:5642/oobi/Es1jlzU-XGhjG8rMrSb1mmoi_KuUNbRouhr8aE3In4dY/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\"}" | jq
curl -s -X POST "http://localhost:5628/oobi" -H "accept: */*" -H "Content-Type: application/json" -d "{\"oobialias\": \"alice\", \"url\":\"http://127.0.0.1:5642/oobi/Es1jlzU-XGhjG8rMrSb1mmoi_KuUNbRouhr8aE3In4dY/witness/BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\"}" | jq
...
curl -s -X POST "http://localhost:5630/registries" -H "accept: */*" -H "Content-Type: application/json" -d "{\"alias\":\"alice\",\"baks\":[],\"estOnly\":false,\"name\":\"vLEI-alice\",\"passcode\":\"DoB2-6Fj4x-9Lbo-AFWJr-a17O\",\"noBackers\":true,\"toad\":0}" | jq
sleep 5
...
echo 'qvi issues OOR credential to alice'
...
sleep 8
echo "alice retrieves Credentials..."
curl -s -X GET "http://localhost:5630/credentials/alice?type=received" -H "accept: application/json" | jq
sleep 3
...
curl -s -X POST "http://localhost:5629/boot" -H "accept: */*" -H "Content-Type: application/json" -d "{\"name\":\"alice\",\"passcode\":\"DoB2-6Fj4x-9Lbo-AFWJr-a17O\",\"salt\":\"0AMDEyMzQ1Njc4OWxtbm9dEf\"}" | jq
sleep 1
curl -s -X PUT "http://localhost:5629/boot" -H "accept: */*" -H "Content-Type: application/json" -d "{\"name\":\"alice\",\"passcode\":\"DoB2-6Fj4x-9Lbo-AFWJr-a17O\"}" | jq
sleep 5
curl -s -X POST "http://localhost:5629/ids/alice" -H "accept: */*" -H "Content-Type: application/json" -d "{\"transferable\":true,\"wits\":[\"BGKVzj4ve0VSd8z_AmvhLg4lqcC_9WYX90k03q-R_Ydo\", \"BuyRFMideczFZoapylLIyCjSdhtqVb31wZkRKvPfNqkw\",\"Bgoq68HCmYNUDgOz4Skvlu306o_NY-NrYuKAVhk3Zh9c\"],\"toad\":3, \"icount\":1,\"ncount\":1,\"isith\":1,\"nsith\":1}" | jq
